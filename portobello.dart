...
class PortobelloWidget extends StatefulWidget {
  const PortobelloWidget({Key key}) : super(key: key);

  @override
  _PortobelloWidgetState createState() => _PortobelloWidgetState();
}

class _PortobelloWidgetState extends State<PortobelloWidget>
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '2bruu883' /* Pan brioche, carne black angus... */,
                            ),
                            style: temascarls.of(context).bodyText2,
                          ),
                        ),
