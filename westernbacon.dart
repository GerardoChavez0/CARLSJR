...
class WesternbaconWidget extends StatefulWidget {
  const WesternbaconWidget({Key key}) : super(key: key);

  @override
  _WesternbaconWidgetState createState() => _WesternbaconWidgetState();
}

class _WesternbaconWidgetState extends State<WesternbaconWidget>
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '1x7m6m24' /* Pan brioche, carne black angus... */,
                            ),
                            style: temascarls.of(context).bodyText2,
                          ),
                        ),
