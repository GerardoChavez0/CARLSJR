...
class GuacamolebaconWidget extends StatefulWidget {
  const GuacamolebaconWidget({Key key}) : super(key: key);

  @override
  _GuacamolebaconWidgetState createState() => _GuacamolebaconWidgetState();
}

class _GuacamolebaconWidgetState extends State<GuacamolebaconWidget>
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'h2x31wsd' /* Pan brioche, carne black angus... */,
                            ),
                            style: temascarls.of(context).bodyText2,
                          ),
                        ),
