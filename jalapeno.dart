...
class JalapenoWidget extends StatefulWidget {
  const JalapenoWidget({Key key}) : super(key: key);

  @override
  _JalapenoWidgetState createState() => _JalapenoWidgetState();
}

class _JalapenoWidgetState extends State<JalapenoWidget>
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'vgsdcj23' /* Pan brioche, carne black angus... */,
                            ),
                            style: temascarls.of(context).bodyText2,
                          ),
                        ),
