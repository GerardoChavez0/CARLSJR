...
class LowcarbWidget extends StatefulWidget {
  const LowcarbWidget({Key key}) : super(key: key);

  @override
  _LowcarbWidgetState createState() => _LowcarbWidgetState();
}

class _LowcarbWidgetState extends State<LowcarbWidget>
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'iqkheye7' /* Lechuga, carne black angus, qu... */,
                            ),
                            style: temascarls.of(context).bodyText2,
                          ),
                        ),
